...
const WhatsappBtn = () => {
  return (
    ...
    >
     <a
      href='https://api.whatsapp.com/send?phone=526631138555&text=Hola,%20me%20interesa%20obtener%20m%C3%A1s%20informaci%C3%B3n%20Platinum%20Resedidencial.' // Reemplaza con tu enlace de WhatsApp
      target='_blank'
