...
import PeekLevel3 from '../../assets/image/plantas platinum-19.png'
import IconNovaPlusPeek from '../../assets/image/nova-16-15.png'
  ...
  return (
    <div className="border-t-[20px] border-[#1c2e60] grid grid-cols-1 md:grid md:grid-cols-3 grid-rows-1 ">
      <div className='col-span-2 p-8 bg-white'>
        <div className='h-auto w-auto flex items-end justify-end '> <img src={IconNovaPlusPeek} alt="" className='lg:w-[525px]' /></div>
        <div className='pl-8'>
          <ul>
      ...
      <div className=' md:flex items-center justify-center  p-[10%] pl-8 bg-white'>
        ...
        >
          ...
          <div className='w-full h-auto'>
            <img src={PeekLevel3} alt="Roof Top" className='w-full h-auto' />
          </div>
        </Carousel>
      </div>
    </div>
